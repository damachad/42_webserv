...
#    Updated: 2024/08/29 14:12:15 by damachad         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NAME 		= webserv
FILES 		= main2 Helpers ConfigParser Exceptions Server Cluster utils LocationContext ServerContext HTTPRequestParser
